...
1. Management: Orchestration agents and tool calling handle judgement and management for defined problems. With enough agents, this is effectively unbounded.
2. Pattern recognition: these are ML models. That’s the best thing they can do.
3. Multi-step complex workflows: planning agents.
4. Legal liability: this is regulatory, not cognitive. When software is better at a task, regulation changes.
5. Trust: computation, work, and reasoning can be cryptographically verified.
6. Cross-context and domain knowledge: Data aggregation and labeling companies will get there eventually. We will be indexing all of human knowledge, thought, and action soon.
